...
|no-delete-var| ✔️  |    |    | ✔️  |
|no-div-regex|    |    |    |    |
|no-dupe-args| ✔️  | ✔️  | ✔️  | ✔️  |
|@ts-eslint/no-dupe-class-members|    |    |    |    |
|no-dupe-class-members| ✔️  | ✔️  | ✔️  | ✔️  |
|no-dupe-else-if| ✔️  |    |    |    |
|no-dupe-keys| ✔️  | ✔️  | ✔️  | ✔️  |
